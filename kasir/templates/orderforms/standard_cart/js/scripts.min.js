...
function elementOutOfViewPort(e) {
    ...
    function P(e, t, n) {
        ...
        if (/^(ch|di|in)/.test(n) && !r) A(e, a);
            ...
            for (var o in r)(r[o] ? A : L)(e, o, !0);
        else t && "toggle" != n || (t || e[R]("ifClicked"), r ? i[M] !== b && L(e, a) : A(e, a))
    }
    ...
    function A(e, t, n) {
        var i, a, r = e[0],
            ...
            c = y(e, u + E(r[M])),
            p = y(e, t + E(r[M]));
        !0 !== r[t] && (!n && t == Q && r[M] == b && r.name && (i = e.closest("form"), a = 'input[name="' + r.name + '"]', (a = i.length ? i.find(a) : g(a)).each(function() {
            this !== r && g(this).data(j) && L(g(this), t)
        })), d ? (r[t] = !0, r[Q] && L(e, Q, "force")) : (n || (r[t] = !0), s && r[k] && L(e, k, !1)), O(e, s, t, n)), r[w] && y(e, m, !0) && o.find("." + C).css(m, "default"), o[T](p || y(e, t) || ""), o.attr("role") && !d && o.attr("aria-" + (l ? w : Q), "true"), o[U](c || y(e, u) || "")
    }
    ...
    function L(e, t, n) {
        var i = e[0],
            ...
            l = y(e, d + E(i[M])),
            u = y(e, t + E(i[M]));
        !1 !== i[t] && (!o && n && "force" != n || (i[t] = !1), O(e, r, d, n)), !i[w] && y(e, m, !0) && a.find("." + C).css(m, "pointer"), a[U](u || y(e, t) || ""), a.attr("role") && !o && a.attr("aria-" + (s ? w : Q), "false"), a[T](l || y(e, d) || "")
    }

    function I(e, t) {
        e.data(j) && (e.parent().html(e.attr("style", e.data(j).s || "")), t && e[R](t), e.off(".i").unwrap(), g(H + '[for="' + e[0].id + '"]').add(e.closest(H)).off(".i"))
    }
    ...
    function O(e, t, n, i) {
        i || (t && e[R]("ifToggled"), e[R]("change")[R]("ifChanged")[R]("if" + E(n)))
    }
    g.fn[j] = function(t, n) {
        function e(e) {
            e.each(function() {
        ...
        var u, i, c, p, h, f, m, y, a = 'input[type="' + v + '"], input[type="' + b + '"]',
            r = g();
        return /^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(t) ? (t = t.toLowerCase(), e(this), r.each(function() {
            var e = g(this);
            "destroy" == t ? I(e, "ifDestroyed") : P(e, !0, t), g.isFunction(n) && n()
        })) : "object" != typeof t && t ? this : (i = (u = g.extend({
            checkedClass: Q,
            disabledClass: w,
            indeterminateClass: k,
            labelHover: !0
        }, t)).handle, c = u.hoverClass || "hover", p = u.focusClass || "focus", h = u.activeClass || "active", f = !!u.labelHover, m = u.labelHoverClass || "hover", y = 0 | ("" + u.increaseArea).replace("%", ""), i != v && i != b || (a = 'input[type="' + i + '"]'), y < -50 && (y = -50), e(this), r.each(function() {
            var i = g(this),
                a = (I(i), this),
                e = a.id,
                t = -y + "%",
                ...
                r = a[M] == v ? u.checkboxClass || "i" + v : u.radioClass || "i" + b,
            ...
            s && o.each(function() {
            ...
            }), l = i.wrap(l + "/>")[R]("ifCreated").parent().append(u.insert), r = g('<ins class="' + C + '"/>').css(t).appendTo(l), i.data(j, {
                o: u,
                s: i.attr("style")
            }).css(n), u.inheritClass && l[T](a.className || ""), u.inheritID && e && l.attr("id", j + "-" + e), "static" == l.css("position") && l.css("position", "relative"), P(i, !0, S), o.length && o.on(x + ".i mouseover.i mouseout.i " + D, function(e) {
                var t = e[M],
                    n = g(this);
                if (!a[w]) {
                    if (t == x) {
                        ...
                        P(i, !1, !0)
                    } else f && (/ut|nd/.test(t) ? (l[U](c), n[U](m)) : (l[T](c), n[T](m)));
                    if (!W) return !1;
                    e.stopPropagation()
                }
                ...
                var t = e[M],
                    e = e.keyCode;
                return t != x && ("keydown" == t && 32 == e ? (a[M] == b && a[Q] || (a[Q] ? L : A)(i, Q), !1) : void("keyup" == t && a[M] == b ? a[Q] || A(i, Q) : /us|ur/.test(t) && l["blur" == t ? U : T](p)))
            }), r.on(x + " mousedown mouseup mouseover mouseout " + D, function(e) {
                var t = e[M],
                    n = /wn|up/.test(t) ? h : c;
                if (!a[w]) {
                    if (t == x ? P(i, !1, !0) : (/wn|er|in/.test(t) ? l[T](n) : l[U](n + " " + h), o.length && f && n == c && o[/ut|nd/.test(t) ? U : T](m)), !W) return !1;
                    e.stopPropagation()
                }
            })
        }))
            ...
            return this.feedbackContainer = function() {
                ...
                switch (e.result) {
                    ...
                    case "linking_complete":
                        var p = "";
                        p = (p = e.remote_account.email || e.remote_account.firstname + " " + e.remote_account.lastname).trim(), c = this.feedbackMessage("linking_complete").trim().replace(":displayName", u), p && (c = c.replace(/\.$/, " (" + p + ").")), this.feedbackContainer().removeClass("alert-danger alert-warning alert-info").addClass("alert alert-success").html(o + c);
                        break;
                    case "login_to_link":
...
WHMCS.hasModule("recaptcha") || WHMCS.loadModule("recaptcha", function() {
    return this.register = function() {
        ...
        e.each(function(e, t) {
            ...
            if (!h) o.data("toggle", "tooltip").data("placement", "bottom").data("trigger", "manual").attr("title", a).hide();
...
function recalculateRenewalTotals() {
    jQuery("#orderSummaryLoader").is(":visible") || jQuery("#orderSummaryLoader").fadeIn("fast");
    var t = Math.floor(1e6 * Math.random() + 1);
    window.lastSliderUpdateRequestId = t, WHMCS.http.jqClient.get(WHMCS.utils.getRouteUrl("/cart/domain/renew/calculate")).done(function(e) {
...
jQuery(document).ready(function() {
    ...
    var a, r, e = jQuery("#inputCardNumber"),
        t = jQuery("#inputCardCVV2"),
        o = (e.length && (e.payment("formatCardNumber"), jQuery("#inputCardCVV").payment("formatCardCVC"), jQuery("#inputCardStart").payment("formatCardExpiry"), jQuery("#inputCardExpiry").payment("formatCardExpiry")), t.length && t.payment("formatCardCVC"), jQuery("#orderSummary"));

    function n() {
        var e, t, n, i;
        "none" === jQuery("#scrollingPanelContainer").css("float") ? o.stop().css("margin-top", "0") : (e = o.outerHeight(), t = 0, n = jQuery("#scrollingPanelContainer").prev("div.secondary-cart-body"), void 0 !== a && (t = a.top), i = jQuery(window).scrollTop() - t + 15, e < jQuery(window).height() ? (n.stop().animate({
            marginTop: 0
        }), r - e < i && (i = r - e), jQuery(window).scrollTop() > t ? o.stop().animate({
            marginTop: i
        }) : o.stop().animate({
            marginTop: 0
        })) : (o.stop().animate({
            marginTop: 0
        }), i + n.height() > o.height() || (jQuery(window).scrollTop() > t ? n.stop().animate({
            marginTop: i
        }) : n.stop().animate({
            marginTop: 0
        }))))
    }
    o.length && (a = jQuery("#scrollingPanelContainer").parent(".row").offset(), r = jQuery("#scrollingPanelContainer").parent(".row").outerHeight() - 35, jQuery(window).resize(function() {
                ...
                if (n.show(), jQuery(".domain-lookup-primary-loader").hide(), "string" != typeof t && !t.error && t.isValidDomain) u.hide(), n = t.pricing, t.isAvailable && "string" != typeof n ? (t.domainName !== t.idnDomainName && m.not(":visible") && m.slideDown(), t.preferredTLDNotAvailable && unavailableTld.show().find("strong").html(t.originalUnavailableTld), s.hide(), i.show().find("strong").html(t.domainName), a.show().find("span.price").html(n[Object.keys(n)[0]].register).end().find("button").attr("data-domain", t.domainName), d.val(t.domainName), l.val(Object.keys(n)[0]).attr("name", "domainsregperiod[" + t.domainName + "]"), f.removeAttr("disabled")) : (i = t.originalUnavailableDomain || t.domainName, r.show().find("strong").html(i), s.hide(), "string" == typeof n && "ContactUs" == n && s.show());
                    ...
                    if (!t.isValidDomain && t.domainErrorMessage) o.text(t.domainErrorMessage);
                        ...
                        if ("string" == typeof t) u.text(t);
                            ...
                            u.text("");
                            for (var c = t.error.split(d), p = 0; p < c.length; p++) {
                                var h = c[p];
                                h.length && (u.text() && u.append("<br />"), u.append(jQuery("<span></span>").text(h)))
                            }
                        } else u.text(t.error);
                        u.show(), a = !0
                    }
    ...
    var u = jQuery("#existingCardsContainer"),
        ...
        t = (jQuery(document).on("ifChecked", ".existing-card", function(e) {
            s.slideUp().find("input").attr("disabled", "disabled"), 1 !== jQuery(".payment-methods:checked").data("remote-inputs") && (i.slideUp().find("input").attr("disabled", "disabled"), "1" !== hideCvcOnCheckoutForExistingCard ? p.slideDown().find("input").removeAttr("disabled") : p.slideUp().find("input").attr("disabled", "disabled"))
        }), h.on("ifChecked", function(e) {
            s.slideDown().find("input").removeAttr("disabled"), 1 !== jQuery(".payment-methods:checked").data("remote-inputs") && (i.slideDown().find("input").removeAttr("disabled"), p.slideUp().find("input").attr("disabled", "disabled"))
        }), jQuery(".payment-methods").on("ifChecked", function(e) {
            var o, s, d, l, i, t = jQuery(document).find(".existing-card");
            t.length || p.slideUp().find("input").attr("disabled", "disabled"), jQuery(this).hasClass("is-credit-card") ? (o = jQuery(this).data("payment-type"), s = jQuery(this).val(), d = jQuery(this).data("show-local"), l = [], "RemoteCreditCard" === o ? c.hide().find("input").prop("disabled", "disabled") : c.not(":visible") && c.slideDown().find("input").removeProp("disabled"), t.each(function(e) {
            ...
            }), 0 < (t = l.filter(function(e) {
                return !jQuery(e).attr("disabled")
            })).length ? (i = null, jQuery.each(t, function(e, t) {
                var t = jQuery(t),
                    n = parseInt(t.data("order-preference"), 10);
                if ((null === i || n < i) && (i = t.val(), 0 === n)) return !1
            }), null === i && (i = "new"), jQuery.each(t, function(e, t) {
                t = jQuery(t);
                if (t.val() === i) return t.iCheck("check"), !1
            }), u.show(), "1" !== hideCvcOnCheckoutForExistingCard ? p.show().find("input").removeAttr("disabled") : p.hide().find("input").attr("disabled", "disabled")) : (jQuery(h).iCheck("check"), u.hide(), p.hide().find("input").attr("disabled", "disabled")), f.is(":visible") || f.slideDown()) : f.slideUp()
            ...
            e.preventDefault(), void 0 !== recaptchaValidationComplete && void 0 !== recaptchaType && "invisible" === recaptchaType && !1 === recaptchaValidationComplete || (e = jQuery("#frmDomainChecker"), t = jQuery("#inputDomain"), o = jQuery("#domainSuggestions"), n = jQuery("#divDynamicRecaptcha"), i = jQuery("#inputCaptcha"), h = jQuery("#idnLanguageSelector"), jQuery(".field-error-msg").hide(), h.is(":visible") && (h.slideUp(), h.find("select").val("")), domainLookupCallCount = 0, t.val() ? (t.tooltip("hide"), jQuery("#captchaContainer").length ? validate_captcha(e) : (n.tooltip("hide"), i.tooltip("hide"), jQuery("#btnCheckAvailability").attr("disabled", "disabled").addClass("disabled"), jQuery(".domain-lookup-result").hide(), jQuery(".domain-lookup-loader").show(), o.find("div:not(.actions)").hide(), o.find(".clone").remove(), jQuery("div.panel-footer.more-suggestions").hide().find("a").show().end().find("span.no-more").hide(), jQuery(".btn-add-to-cart").removeAttr("disabled").find("span").hide().end().find("span.to-add").show(), jQuery("#DomainSearchResults").not(":visible") && jQuery(".domain-pricing").fadeOut("fast", function() {
                        ...
                        if (!t.isValidDomain && t.domainErrorMessage) d.text(t.domainErrorMessage);
                            ...
                            if ("string" == typeof t) l.text(t);
                                ...
                                for (var u = t.error.split(i), c = 0; c < u.length; c++) {
                                    var p = u[c];
                                    p.length && (l.text() && l.append("<br />"), l.append(jQuery("<span></span>").text(p)))
                                }
                            } else l.text(t.error);
                            l.show(), n = !0
                        }
                ...
                "object" != typeof e || 0 == e.result.length || e.result.error ? jQuery(".suggested-domains").fadeOut("fast", function() {
                    ...
                    var n = t.tld,
                        i = t.pricing,
                        a = (o.find("div:first").clone(!0, !0).appendTo(o), o.find("div.domain-suggestion").last());
                    a.addClass("clone").find("span.domain").html(t.sld).end().find("span.extension").html("." + n), "string" == typeof i ? (a.find("button.btn-add-to-cart").remove(), "" != i ? a.find("button.domain-contact-support").show().end().find("span.price").hide() : a.remove()) : (t.domainName !== t.idnDomainName && h.not(":visible") && h.slideDown(), a.find("button.btn-add-to-cart").attr("data-domain", t.domainName).end().find("span.price").html(i[Object.keys(i)[0]].register)), r <= 10 && a.show(), r++, t.group && (a.find("span.promo").addClass(t.group).show(), a.find("span.sales-group-" + t.group).show()), 0 < (furtherSuggestions = o.find("div.domain-suggestion.clone:hidden").length) && jQuery("div.more-suggestions").show()
                }), jQuery(".domain-lookup-suggestions-loader").hide(), jQuery("#domainSuggestions").show())
            }).always(function() {
                hasDomainLookupEnded()
    ...
    d.is(":visible") && 1 === d.data("apply-credit") && t.length && (e.iCheck("check"), t.iCheck("check")), jQuery("#domainRenewals").find("span.added").hide().end().find("span.to-add").find("i").hide(), jQuery(".btn-add-renewal-to-cart").on("click", function() {
        var t = jQuery(this),
            e = t.data("domain-id"),
            n = jQuery("#renewalPricing" + e).val();
        t.hasClass("checkout") ? window.location = whmcsBaseUrl + "/cart.php?a=view" : (t.attr("disabled", "disabled").each(function() {
            jQuery(this).find("i").fadeIn("fast").end().css("width", jQuery(this).outerWidth())
        }), WHMCS.http.jqClient.post(WHMCS.utils.getRouteUrl("/cart/domain/renew/add"), {
            domainId: e,
            period: n,
            token: csrfToken
        }, null, "json").done(function(e) {
            t.find("span.to-add").hide(), "added" === e.result && t.find("span.added").show().end().find("i").fadeOut("fast").css("width", t.outerWidth()), recalculateRenewalTotals()
        }))
    ...
    }), (checkoutForm = jQuery("#frmCheckout")).length && checkoutForm.on("submit", validateCheckoutCreditCardInput), jQuery(".payment-methods:checked").trigger("ifChecked"), u.is(":visible") && 0 < u.find("input.existing-card").length && i.slideUp()
});